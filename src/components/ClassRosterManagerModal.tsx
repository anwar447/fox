...
export const ClassRosterManagerModal: React.FC<ClassRosterManagerModalProps> = ({
  ...
  const filteredStudents = allSchoolStudents.filter((student) => {
    // Class filter
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-900/60 backdrop-blur-xs animate-fadeIn overflow-y-auto">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl max-w-6xl w-full p-4 sm:p-6 text-right space-y-4 shadow-2xl text-slate-800 my-auto max-h-[94vh] flex flex-col">
