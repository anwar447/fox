...
export const INITIAL_PERMISSIONS: StudentPermission[] = [
  ...
  },
  {
    id: 'perm-exit-demo-1',
    studentId: 'usr-std-2',
    studentName: 'خالد عمر عبدالله الشمري',
    nationalId: '1100220022',
    schoolCode: 'RAYA-1448',
    className: 'الأول المتوسط',
    sectionName: '1',
    ...
    timeIn: null,
    teacherId: 'usr-emp-1',
    teacherName: 'أ. عبدالله ناصر القحطاني (مدير المدرسة)',
    reason: 'medical_appointment',
    permissionType: 'school_exit',
    exitGateStatus: 'pending_guard_approval',
    pickupPerson: 'عمر عبدالله الشمري (ولي الأمر)',
    pickupRelation: 'ولي الأمر',
    pickupPhone: '0552233445',
    approvedByRole: 'principal',
    notes: 'إذن خروج رسمي لمراجعة موعد مستشفى معتمد',
    createdAt: new Date().toISOString(),
  },
];
